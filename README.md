...
```
## OUTPUT:
![Screenshot 2024-10-16 145705](https://github.com/user-attachments/assets/c2ea255d-7f5d-42db-8859-5b101d638838)
...
```
## OUTPUT:
![Screenshot 2024-10-16 145807](https://github.com/user-attachments/assets/88aa027e-3421-4e4e-8673-abd31f017b8b)
```
!nvprof ./matmul
```
## OUTPUT:
![image](https://github.com/user-attachments/assets/0e2420d1-9ae7-4ed5-8142-9d950100a330)
```
!nvprof --print-gpu-trace ./matmul
```
## OUTPUT:
![image](https://github.com/user-attachments/assets/77b7cfc9-d79a-42a2-9df5-23593ecbce38)
